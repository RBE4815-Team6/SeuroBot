...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MoveRobotGoal>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%#goal definition~%int32 x~%int32 y~%int32 z~%int32 roll~%int32 pitch~%int32 yaw~%string frame~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MoveRobotGoal)))
  "Returns full string definition for message of type 'MoveRobotGoal"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%#goal definition~%int32 x~%int32 y~%int32 z~%int32 roll~%int32 pitch~%int32 yaw~%string frame~%~%~%"))
