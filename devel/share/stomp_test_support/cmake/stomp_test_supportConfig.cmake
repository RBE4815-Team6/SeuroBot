...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'stomp_test_support' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/avrs/seurobot_ws/src/industrial_moveit/stomp_test_support/${idir}'.  ${_report}")
    endif()
